...
def displayFormat3():
    # Uses a 4-digit representation that includes 2 digits for the fractional part:
    pi, r = 3.1416, 4.7
    ch ="The area of a disk of radius {} is equal to {:5.2f}." # maybe {:5}
    print(ch.format(r, pi * r**2))
...
# Tuples: are like chains of characters, but is not changeable:
# Syntax:
# tup = ('a', 'b', 'c', 'd', 'e')
...
# to make the change you need to create a new object while keeping the same name:
# You cannot concatenate tuples:
# tup = ('a','X') + tup[2:]
# print(tup) --> ('a', 'X', 'c', 'd', 'e')
# tup1, tup2 = ("a","b"), ("c","d", 'e')
# tup3 = tup1*2 + tup2
...
# To execute:
# obj = (10,20,30,40)
# f(obj) --> error: TypeError: 'tuple' object does not support item assignment
# print(obj) --> prints the tuple: (10,20,30,40)
...
# check data type:
# print(type(a)) --> ‘dict’
# then use the funciont set: a = set()
# print(type(a)) --> ‘set'

# Sets are mutable. But they are unordered, indexing has no meaning.
